...
class RMS:
    def __init__(self, root):
        ...
        btn_course = Button(
            ...
            fg="white",
            cursor="hand2",
        ).place(x=20, y=5, width=250, height=40)
        ...
        btn_student = Button(
            ...
            fg="white",
            cursor="hand2",
        ).place(x=280, y=5, width=250, height=40)
        ...
        btn_result = Button(
            ...
            fg="white",
            cursor="hand2",
        ).place(x=540, y=5, width=250, height=40)
        ...
        btn_view = Button(
            ...
            fg="white",
            cursor="hand2",
        ).place(x=800, y=5, width=250, height=40)
        ...
        btn_exit = Button(
            ...
            fg="white",
            cursor="hand2",
        ).place(x=1060, y=5, width=250, height=40)
        ...
        footer = Label(
            self.root,
            text="Student Result Management System\nContact Us for any Technical Issue: 9899459288",
